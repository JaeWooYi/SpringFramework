...
public class UserDetailsService implements org.springframework.security.core.userdetails.UserDetailsService{	// 스프링에서 기본적으로 만들어져있는 인터페이스를 사용하자
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if(mvo != null) {
//			return mvo;	// 그냥 return mvo; 는 안돼니 new MemberUser(mvo)로 해야해 -> Member, Auth정보를 Meberuser에 넣어 주는거야 
